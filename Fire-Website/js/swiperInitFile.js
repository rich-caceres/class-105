...
window.addEventListener('resize', function(){swiper3.update(),swiper3.updateSize()})

new ResizeSensor(jQuery('#SPECOP'), () => {swiper2.update(),swiper2.updateSize()})

new ResizeSensor(jQuery('#collapseTwo'), () => {swiper1.update(),swiper1.updateSize()})